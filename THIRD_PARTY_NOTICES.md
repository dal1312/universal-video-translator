...
yt-dlp, and their dependencies. Each component remains subject to its own
...
Ollama, the selected Ollama model, Deno, VB-Cable, and downloaded AI models are
not included in the portable archive. Their own licenses and privacy policies
apply when users install or download them.
